...
# API Configuration
try:
    api_key = os.environ["SOCHFLOW_API_KEY"]
except KeyError:
    raise ValueError("SOCHFLOW_API_KEY environment variable not found. Please set your API key in the environment variables.")
